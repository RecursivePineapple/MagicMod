...
public class VoxelAABB implements Iterable<Vector3ic> {
    ...
    public VoxelAABB setOrigin(Vector3i newOrigin) {
        b.sub(origin)
            .add(newOrigin);
        a.sub(origin)
            .add(newOrigin);
    ...
    public AABBf toAABBf() {
        ...
        return new AABBf(min.x, min.y, min.z, max.x + 1, max.y + 1, max.z + 1);
    }
